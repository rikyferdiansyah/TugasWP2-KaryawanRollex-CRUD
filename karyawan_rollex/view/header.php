...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Karyawan Rollex ID</title>
  ...
  <body>
    <nav class="navbar navbar-default">
          ...
          <table>
            <tr>
              <td><img src="images/logo_jam.png" class="img-responsive" style="max-height:25px"></td>
              <td><a class="navbar-brand" href="#">PT. ROLLEX ID</a></td>
            </tr>
          </table>
  			</div>
